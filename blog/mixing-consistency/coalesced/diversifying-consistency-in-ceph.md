...
For primary-copy replication, let’s compare the behavior of read operations between the primary OSD
...
Finally, bolt-on assumes that reads will obey the happens-before relation, that the datastore
